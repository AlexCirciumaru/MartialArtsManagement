			...
			<form:form cssClass="form-horizontal" method="post"
				...
				<div class="form-group">
					...
					<div class="col-xs-6">
						...
						<form:radiobutton path="trainer" value="true" />
						Yes
						<form:radiobutton path="trainer" value="false" />
						No
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-xs-6">
						<form:select path="clubId" required="true" cssClass="form-control">
							<form:option value="">--Select--</form:option>
							<form:options items="${clubs}" itemLabel="clubName"
								itemValue="id" />
						</form:select>
					</div>
				</div>
